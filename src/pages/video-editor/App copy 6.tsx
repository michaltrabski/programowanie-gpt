...
const SegmentEditor: React.FC<SegmentEditorProps> = ({ segments, onUpdate }) => {
        ...
        {segments.map((seg, idx) => (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => adjustTime(idx, 0, -0.5)}
                className="w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded text-red-300"
              >
                -
              </button>
              <button
              ...
              <button
                onClick={() => adjustTime(idx, 0, 0.5)}
                className="w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded text-green-300"
              >
                +
              </button>
            </div>
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-8 font-sans">
      ...
      <div className="w-full max-w-2xl bg-gray-800 p-6 rounded-lg">
        ...
        <SegmentEditor
          ...
          onUpdate={(newSegs) => {
            syncState(newSegs);
            // Optionally auto-stop if editing while playing to avoid bugs
            // stopAll();
          }}
        />
