...
interface CVLabels {
  aboutMe: string; // CHANGED FROM summary
  experience: string;
  education: string;
  skills: string;
  languages: string;
...
interface CVData {
  ...
  fullName: string;
  title: string;
  aboutMe: SummaryItem[]; // CHANGED FROM summary
  contact: ContactInfo;
  skills: SkillSet[];
  languages: Language[];
  interests: string[];
...
const INITIAL_DATA: CVData = {
  labels: {
    aboutMe: "O mnie", // CHANGED FROM summary
      ...
      <div id={wrapperId} className={baseClass} style={{ ...commonStyles, padding: "40px" }}>
        ...
        <section className="mb-8">
          <Editable
            ...
            value={labels.aboutMe} // CHANGED
            onUpdate={(v) => onUpdate(["labels", "aboutMe"], v)} // CHANGED
          />
          {/* UPDATED: AboutMe List */}
              ...
              (
                ...
                <li key={item.id} className="pl-2">
                  <span className="font-bold mr-1">
                    <Editable value={item.main} onUpdate={(v) => onUpdate(["aboutMe", idx, "main"], v)} /> // CHANGED
                  </span>
                  <span className="block md:inline">
                    <Editable value={item.text} onUpdate={(v) => onUpdate(["aboutMe", idx, "text"], v)} /> // CHANGED
                  </span>
                </li>
              )
            )}
