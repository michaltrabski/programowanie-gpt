              ...
              {data.skills.map((skill, idx) => (
                <div key={idx} className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {skill.items.map((item, i) => (
                      <span key={i} className="text-xs border border-gray-300 px-1 rounded text-gray-600">
                        <Editable value={item} onUpdate={(v) => onUpdate(["skills", idx, "items", i], v)} />
                      </span>
                    ))}
                  </div>
            ...
            <section>
              ...
              {data.skills.map((skill, idx) => (
                <div key={idx} className="mb-3">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {skill.items.map((item, i) => (
                      <span key={i} className="text-xs bg-pink-50 text-pink-800 px-2 py-1 rounded-full">
                        <Editable value={item} onUpdate={(v) => onUpdate(["skills", idx, "items", i], v)} />
                      </span>
                    ))}
                  </div>
            ...
            <section>
              ...
              {data.skills.map((skill, idx) => (
                <div key={idx} className="mb-2 text-sm">
                  ...
                  <span>
                    {skill.items.map((item, i) => (
                      <span key={i} className="after:content-[',_'] last:after:content-['']">
                        <Editable value={item} onUpdate={(v) => onUpdate(["skills", idx, "items", i], v)} />
                      </span>
                    ))}
                  </span>
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-4 space-y-4">
            ...
            <section>
              ...
              <div className="text-xs">
                {data.languages.map((lang, idx) => (
                  <div key={idx} className="flex justify-between mb-1 border-b border-gray-100 pb-1">
                    <Editable
                      className="font-semibold"
                      value={lang.language}
                      onUpdate={(v) => onUpdate(["languages", idx, "language"], v)}
            ...
            <section>
              ...
              {data.education.map((edu, idx) => (
                <div key={idx} className="mb-2 text-xs border-b border-gray-200 pb-1 last:border-0">
                  <Editable
                    className="font-bold block"
                    value={edu.school}
                    onUpdate={(v) => onUpdate(["education", idx, "school"], v)}
      ...
      <div id={wrapperId} className={baseClass} style={{ ...commonStyles, padding: "40px" }}>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            {data.aboutMe.map((item, idx) => (
              <div key={item.id} className="border-t-2 border-blue-100 pt-2">
        ...
        <div className="flex gap-8">
          ...
          <div className="w-1/3 space-y-8">
            ...
            <section>
              ...
              />
              {data.education.map((edu, idx) => (
                <div key={idx} className="mb-3 border-l-2 border-gray-200 pl-3">
                  <Editable
