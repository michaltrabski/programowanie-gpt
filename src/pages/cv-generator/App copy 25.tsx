  ...
  return (
    <div className={`relative group transition-all ${className}`}>
      ...
      <button
        onClick={(e) => {
          e.stopPropagation();
          // Removed alert confirmation - immediate delete
          onRemove();
        }}
        contentEditable={false}
        // Updated Styling: Red background, white text, always visible on hover
          ...
          <div className="bg-white rounded-xl shadow-md p-4 flex flex-col h-full border border-gray-200 overflow-y-auto">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                <StyleGroup
                  title="ECOMMERCE"
                  styles={["ecommerce-1", "ecommerce-2", "ecommerce-3"]}
                  current={selectedStyle}
                  set={setSelectedStyle}
                  labels={["Scale", "Brand", "Elegant"]}
                />
                <StyleGroup
                  title="MARKETING"
                  styles={["marketing-1", "marketing-2", "marketing-3"]}
                  current={selectedStyle}
                  set={setSelectedStyle}
                  labels={["Bold", "Creative", "Vibrant"]}
                />
                <StyleGroup
                  title="LOGISTICS"
                  styles={["logistics-1", "logistics-2", "logistics-3"]}
                  current={selectedStyle}
                  set={setSelectedStyle}
                  labels={["Corp", "Data", "Grid"]}
                />
                <StyleGroup
                  title="ENGINEERING"
                  styles={["engineering-1", "engineering-2", "engineering-3"]}
                  current={selectedStyle}
                  set={setSelectedStyle}
                  labels={["Terminal", "Clean", "Docs"]}
                />
              </div>
            </div>
...
const TemplateRenderer = ({
  ...
  // --- ECOMMERCE 3: Elegant Serif ---
  if (style === "ecommerce-3") {
    return (
      <div id={wrapperId} className={`${baseClass} font-serif`} style={{ ...commonStyles, padding: "50px" }}>
        <header className="text-center mb-10 pb-6 border-b border-gray-200">
          ...
          <Editable
            ...
            onUpdate={(v) => onUpdate(["title"], v)}
          />
          <div className="text-sm text-gray-500 flex justify-center gap-4 uppercase tracking-widest font-sans">
        ...
        <section className="mb-10">
          <h3 className="text-center text-sm font-sans font-bold uppercase tracking-widest text-gray-400 mb-6">
              ...
              <Removable key={exp.id} onRemove={() => onRemove(["experience"], idx)}>
                <div className="grid grid-cols-12 gap-4">
                  <div className="col-span-3 text-right">
                    ...
                    />
                    <Editable
                      className="block text-xs text-gray-500 font-sans mt-1"
                      value={exp.duration}
                      onUpdate={(v) => onUpdate(["experience", idx, "duration"], v)}
                    />
                  </div>
        ...
        <div className="grid grid-cols-2 gap-12 border-t border-gray-200 pt-8">
          <section>
            <h3 className="text-sm font-sans font-bold uppercase tracking-widest text-gray-400 mb-4">
              ...
              <Removable key={idx} onRemove={() => onRemove(["skills"], idx)} className="mb-4">
                <div className="flex justify-between items-baseline border-b border-gray-100 pb-1">
                  <Editable
                    ...
                    onUpdate={(v) => onUpdate(["skills", idx, "category"], v)}
                  />
                  <div className="text-right text-sm text-gray-600 w-2/3">
                    {skill.items.map((item, i) => (
                      <Removable
                        key={i}
                        onRemove={() => onRemove(["skills", idx, "items"], i)}
  ...
  // --- MARKETING 2: Creative (Sidebar) ---
  if (style === "marketing-2" || style === "ecommerce-2") {
    // Reusing the sidebar logic but ensures it works for both keys if user selects them
    return (
      <div id={wrapperId} className={baseClass} style={{ ...commonStyles, display: "flex" }}>
        ...
        <div className="w-[30%] bg-gray-900 text-white p-8 flex flex-col gap-8">
          ...
          {/* ... Rest of Sidebar Logic is same as before, simplified for brevity here ... */}
          {/* Include Skills, Languages, Education from previous sidebar logic */}
          <div>
            <Editable
              tag="h3"
  ...
  // --- MARKETING 1: Modern Bold ---
  if (style === "marketing-1") {
    // ... existing marketing-1 code ...
    return (
  ...
  // --- MARKETING 3: Vibrant Header ---
  if (style === "marketing-3") {
    return (
      <div id={wrapperId} className={baseClass} style={{ ...commonStyles, padding: "0" }}>
        <header className="bg-indigo-600 text-white p-10 flex justify-between items-start">
          <div className="w-2/3">
            <Editable
              tag="h1"
          ...
          {image && (
            <img
              src={image}
              alt="Profile"
              className="w-32 h-32 rounded-full object-cover border-4 border-indigo-400 bg-white"
            />
          )}
        </header>
        ...
        <div className="grid grid-cols-12 min-h-[800px]">
          <div className="col-span-4 bg-gray-50 p-8 border-r border-gray-100">
            ...
            <section className="mb-8">
              <Editable
                tag="h3"
                className="text-xs font-bold uppercase text-indigo-600 tracking-wider mb-4 border-b border-gray-200 pb-1"
                value={labels.skills}
                onUpdate={(v) => onUpdate(["labels", "skills"], v)}
              />
              <div className="space-y-4">
                  ...
                  <Removable key={idx} onRemove={() => onRemove(["skills"], idx)}>
                    <div className="mb-2">
                      <Editable
                        ...
                        onUpdate={(v) => onUpdate(["skills", idx, "category"], v)}
                      />
                      <div className="text-sm text-gray-500">{skill.items.join(", ")}</div>
                    </div>
                  </Removable>
                ))}
              </div>
            ...
            <section>
              ...
              />
              {data.education.map((edu, idx) => (
                <Removable key={idx} onRemove={() => onRemove(["education"], idx)} className="mb-3">
                  <div>
                    <Editable
          ...
          <div className="col-span-8 p-8">
            ...
            <section>
              <Editable
                ...
                onUpdate={(v) => onUpdate(["labels", "experience"], v)}
              />
              <div className="border-l-2 border-indigo-100 ml-3 pl-6 space-y-8">
                {data.experience.map((exp, idx) => (
                  <Removable key={exp.id} onRemove={() => onRemove(["experience"], idx)}>
                    <div className="relative">
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          />
                          <Editable
                            className="text-sm font-semibold text-indigo-500 block"
                            value={exp.company}
                            onUpdate={(v) => onUpdate(["experience", idx, "company"], v)}
                          />
                        </div>
                        <Editable
                          tag="span"
                          className="text-xs font-bold text-gray-400 bg-gray-100 px-2 py-1 rounded"
                          value={exp.duration}
                          onUpdate={(v) => onUpdate(["experience", idx, "duration"], v)}
                        />
                      </div>
                      <ul className="list-disc ml-4 mt-3 text-sm text-gray-600">
                        {exp.description.map((desc, i) => (
                          <Removable key={i} onRemove={() => onRemove(["experience", idx, "description"], i)}>
                            <li className="mb-1">
                              <Editable
  ...
  // --- LOGISTICS 1: Corporate ---
  if (style === "logistics-1") {
    // ... existing logistics-1 logic ...
    return (
  ...
  // --- LOGISTICS 3: Strict Grid ---
  if (style === "logistics-3") {
    return (
      <div id={wrapperId} className={baseClass} style={{ ...commonStyles, padding: "40px" }}>
        <header className="border-b-4 border-gray-800 pb-4 mb-6">
          <div className="flex justify-between items-end">
            ...
            <div className="text-right text-xs font-mono bg-gray-100 p-2 rounded">
              <Editable
                className="block"
                value={data.contact.email}
                onUpdate={(v) => onUpdate(["contact", "email"], v)}
        ...
        <section className="mb-8 bg-gray-50 p-4 border border-gray-200">
          <Editable
            tag="h3"
            className="text-xs font-bold text-gray-900 uppercase mb-2 border-b border-gray-300 pb-1"
            value={labels.aboutMe}
            onUpdate={(v) => onUpdate(["labels", "aboutMe"], v)}
          />
          <div className="grid grid-cols-2 gap-4">
        ...
        <section className="mb-8">
          <Editable
            tag="h3"
            className="text-sm font-bold bg-gray-800 text-white p-2 uppercase mb-4"
            value={labels.experience}
            onUpdate={(v) => onUpdate(["labels", "experience"], v)}
          />
          <div className="space-y-4">
            {data.experience.map((exp, idx) => (
              <Removable key={exp.id} onRemove={() => onRemove(["experience"], idx)}>
                <div className="grid grid-cols-12 border-b border-gray-300 pb-4">
                  <div className="col-span-3 text-sm">
                    <Editable
                      className="font-bold block text-gray-900"
                      value={exp.company}
                      onUpdate={(v) => onUpdate(["experience", idx, "company"], v)}
                    />
                    <Editable
                  ...
                  <div className="col-span-9 pl-4">
                    <Editable
                      ...
                      onUpdate={(v) => onUpdate(["experience", idx, "role"], v)}
                    />
                    <ul className="list-square ml-4 text-xs text-gray-700">
                      {exp.description.map((desc, i) => (
                        <Removable key={i} onRemove={() => onRemove(["experience", idx, "description"], i)}>
                          <li>
                            <Editable
        ...
        <div className="grid grid-cols-2 gap-8">
          <section>
            <Editable
              tag="h3"
              className="text-sm font-bold bg-gray-200 text-gray-800 p-2 uppercase mb-2"
              value={labels.skills}
              onUpdate={(v) => onUpdate(["labels", "skills"], v)}
            />
            {data.skills.map((skill, idx) => (
              <Removable
                key={idx}
                onRemove={() => onRemove(["skills"], idx)}
                className="mb-2 text-xs border-b border-gray-100 pb-1"
              >
                <div>
                  <Editable
                    className="font-bold block"
          ...
          <section>
            ...
            />
            {data.education.map((edu, idx) => (
              <Removable key={idx} onRemove={() => onRemove(["education"], idx)} className="mb-2 text-sm">
  ...
  // --- ENGINEERING 1: Terminal ---
  if (style === "engineering-1") {
    // ... existing engineering-1 code ...
    return (
      <div
        id={wrapperId}
        ...
        <header className="border-b-2 border-dashed border-gray-400 pb-6 mb-8">
          ...
          <div className="text-xs bg-gray-100 p-2 inline-block rounded">
            ...
            <span className="ml-2 block">
              email: "<Editable value={data.contact.email} onUpdate={(v) => onUpdate(["contact", "email"], v)} />
              ",
            </span>
            <span className="ml-2 block">
              phone: "<Editable value={data.contact.phone} onUpdate={(v) => onUpdate(["contact", "phone"], v)} />
              ",
            </span>
            <span className="ml-2 block">
              loc: "<Editable value={data.contact.location} onUpdate={(v) => onUpdate(["contact", "location"], v)} />"
            </span>
            {"}"};
          </div>
        </header>
      ...
      <div id={wrapperId} className={baseClass} style={{ ...commonStyles, display: "flex" }}>
        <div className="flex-1 p-10 bg-white">
          <header className="mb-8 border-b border-gray-300 pb-4">
            ...
            <Editable
              tag="p"
              className="text-lg text-gray-600 font-mono mt-1"
              value={data.title}
              onUpdate={(v) => onUpdate(["title"], v)}
            />
          </header>
          ...
          <section className="mb-8">
            <Editable
              ...
              onUpdate={(v) => onUpdate(["labels", "aboutMe"], v)}
            />
            <div className="bg-gray-50 p-4 border-l-4 border-blue-500 text-sm text-gray-700">
              {data.aboutMe.map((item, idx) => (
                <Removable key={item.id} onRemove={() => onRemove(["aboutMe"], idx)}>
                  <p className="mb-2 last:mb-0">
                    <span className="font-bold">{item.main}:</span> {item.text}
                  </p>
                </Removable>
              ))}
            </div>
              ...
              {data.experience.map((exp, idx) => (
                <Removable key={exp.id} onRemove={() => onRemove(["experience"], idx)}>
                  <div>
                    ...
                    <ul className="list-decimal ml-5 text-sm text-gray-600 font-mono">
                      {exp.description.map((desc, i) => (
                        <Removable key={i} onRemove={() => onRemove(["experience", idx, "description"], i)}>
                          <li>
                            <Editable
        ...
        {/* Right Sidebar */}
        <div className="w-[30%] bg-gray-100 p-8 border-l border-gray-200 text-sm">
          <div className="mb-8">
            <h3 className="font-bold text-gray-400 uppercase text-xs mb-2">Contact</h3>
            <div className="font-mono text-gray-700 space-y-1 break-words">
              <Editable
                className="block"
                value={data.contact.email}
                onUpdate={(v) => onUpdate(["contact", "email"], v)}
          ...
          <div className="mb-8">
            <Editable
              tag="h3"
              className="font-bold text-gray-400 uppercase text-xs mb-2"
              value={labels.skills}
              onUpdate={(v) => onUpdate(["labels", "skills"], v)}
            />
            <div className="space-y-4">
              {data.skills.map((skill, idx) => (
                <Removable key={idx} onRemove={() => onRemove(["skills"], idx)}>
                  <div>
                    <Editable
                      className="font-bold block text-gray-800 mb-1"
                      value={skill.category}
                      onUpdate={(v) => onUpdate(["skills", idx, "category"], v)}
                    />
                    <div className="font-mono text-xs text-gray-600 leading-tight">
                      {skill.items.map((item, i) => (
                        <Removable key={i} onRemove={() => onRemove(["skills", idx, "items"], i)} className="inline">
                          <span className="after:content-[',_'] last:after:content-['']">
                            <Editable value={item} onUpdate={(v) => onUpdate(["skills", idx, "items", i], v)} />
                          </span>
                        </Removable>
            ...
            {data.education.map((edu, idx) => (
              <Removable key={idx} onRemove={() => onRemove(["education"], idx)} className="mb-3">
                <div>
                  ...
                  />
                  <Editable
                    className="text-xs font-mono text-gray-400 block"
                    value={edu.year}
                    onUpdate={(v) => onUpdate(["education", idx, "year"], v)}
                  />
                </div>
  ...
  // Fallback for others (engineering-2 and logistics-2 remain as per original code logic but shortened here for fit)
  // ... Include Engineering-2 and Logistics-2 logic here if needed, or rely on default return ...
  // For safety, re-include Engineering-2 and Logistics-2 fully:

  if (style === "engineering-2") {
    // ... code for engineering-2 ...
    return (
      <div id={wrapperId} className={baseClass} style={{ ...commonStyles, padding: "40px" }}>
