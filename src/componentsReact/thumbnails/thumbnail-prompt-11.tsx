...
// --- PALETTE Presets: red, orange, yellow, green, blue
const PRESET_COLORS = [
  "#F44242", // red
  "#F58D2D", // orange
  "#F8D94F", // yellow
...
const OverlayImageEditor: React.FC = () => {
  ...
  // On upload: reset state, set up for new image
  ...
  // When image loads, extract palette
  useEffect(() => {
    if (!image) {
    ...
    return (
      <div
        ...
        style={{
          ...
          textAlign: "center",
          maxWidth: "94%",
          whiteSpace: "nowrap", // <<<<<<<<<<<<<<<< NEVER wrap: long text stays single-line
          overflowX: "auto",
          overflowY: "hidden",
