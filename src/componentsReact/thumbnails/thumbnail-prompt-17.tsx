...
// Use 6-digit hex for inputs and consistency
...
const OverlayImageEditor: React.FC = () => {
  ...
  const [mainTextColor, setMainTextColor] = useState<string>(toHex6(persisted?.mainTextColor ?? "#FFFFFF"));
  const [secTextColor, setSecTextColor] = useState<string>(toHex6(persisted?.secTextColor ?? "#FFFFFF"));
  ...
  const [arrowColor, setArrowColor] = useState<string>(toHex6(persisted?.arrowColor ?? "#FFFFFF"));
